<?php if ( is_single() ) : ?>
    ...
    <div class="ablog__text ablog__text4">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php comments_link(); ?>">
                        ...
                        <?php comments_number( esc_html__('No Comments', 'airvice'), esc_html__('1 Comment', 'airvice'), esc_html__('% Comments', 'airvice') ); ?>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="blog__deatails--tag wow fadeInUp">
            <span><?php echo esc_html__('Post Tags :', 'airvice'); ?></span>
            <?php airvice_tags(); ?>
        </div>
    </div>
