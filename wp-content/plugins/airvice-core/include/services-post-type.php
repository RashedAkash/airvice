 ...
 */
function solub_services_post_type() {
	$labels = array(
	...
	$labels = array(
		...
		'view_item'         => __( 'View Services Category', 'textdomain' ),
		...
		'not_found'         => __( 'No Services Categories Found', 'textdomain' ),
		'back_to_items'     => __( 'Back to Services Categories', 'textdomain' ),
	...
	register_taxonomy( 'sv-category', 'services', $args );


}

add_action( 'init', 'solub_services_post_type' );