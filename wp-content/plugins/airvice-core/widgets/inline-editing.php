...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'airvice-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Title', 'airvice-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'airvice-core' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'airvice-core' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'airvice-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'airvice-core' ),
			]
		);
